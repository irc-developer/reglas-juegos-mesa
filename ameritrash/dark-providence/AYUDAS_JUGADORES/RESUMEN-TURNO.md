...
<img src="../img/icons/viaje.png" alt="[MOV]" width="18"> Viaje ·
<img src="../img/icons/poder.png" alt="[POD]" width="18"> Poder ·
<img src="../img/icons/bloqueo.png" alt="[BLOQ]" width="18"> Bloqueo ·
<img src="../img/icons/cordura.png" alt="[COR]" width="18"> Prueba de Cordura ·
<img src="../img/icons/locura.png" alt="[LOC]" width="18"> Locura
...
1. Tus cubos van al Limbo.
2. Cubos rivales vuelven a sus suministros.
3. Reclama carta/Ciudad.
4. Resuelve efectos de RECLAMAR.
5. Haz Prueba de Cordura si la carta lo indica.
...
5. Toma la ficha del Agente asesinado y ponla en tu Cripta. El rival aniquila su carta.
...
Hazla al reclamar una carta con icono de Cordura <img src="../img/icons/cordura.png" alt="[COR]" width="18"> o al abrir/cerrar Portal.

1. Roba 1 ficha de la bolsa.
2. Colocala en tu tablero.
3. Con la 3ª Locura, revela Lealtad:
   - Sectario: sigue la partida con Lealtad revelada.
   - Investigador o Disidente: se dispara el final.
