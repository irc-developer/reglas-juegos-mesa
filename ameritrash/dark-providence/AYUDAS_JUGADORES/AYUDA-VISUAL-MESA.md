...
**Propósito**: especificacion para una ayuda imprimible de una página  
**Fuente**: `resumendk.pdf`, reglamento ES p. 24, secciones completas relacionadas y aclaraciones BGG del diseñador  
...
La hoja visual debe cubrir las reglas que más interrumpen la partida:

1. Asesinar.
2. Cerrar o abrir Portal.
3. Prueba de Cordura.
4. Desencadenantes del final.
5. Puntuación por Lealtad.
...
1. Turno: 2 acciones + acciones gratuitas; después roba hasta 5.
2. Si vas a Reclamar, no hagas acciones gratuitas antes.
3. Reclamar requiere: primera acción normal, mayoría, al menos 1 cubo propio y sin Bloqueo.
4. Añadir Influencia coloca cubos en 1 único objetivo, salvo excepcion de carta.
...
4. La carta que habilita la acción no aporta Poder.
...
- Agente principal: solo si el jugador no tiene otros Agentes y tiene 5 PV o más.
...
- Esa Locura también cuenta para el límite de 3 Locuras del jugador.
...
- Ritual o Investigación llega al final.
- Profundos: acción jugada con los 8 en juego.

Nota: Profundos asesinados vuelven al suministro personal; Profundos aniquilados se retiran de la partida.

---

## Bloque 5 - Puntuación rápida
...
- 1 PV por Resucitado.
- +8 PV por Profundos si reclamados y los 8 están en juego.
...
- 1 PV por Agente en Cripta.
- No PV de facción por cartas/Agentes.
- Nunca tienen compañeros, aunque Impostor cambie su etiqueta.
...
2. Entre los restantes, gana quien tenga más PV.
3. Empate por arriba: más Mitos, luego prioridad de Lealtad, luego compartida.
...
- Dos columnas: acciones a la izquierda, puntuación a la derecha.
...
- La ayuda debe funcionar en escala de grises; no codificar información solo por color.
- Cada icono debe ir acompanado por texto o código corto.
- Evitar fondos con textura fuerte detras de reglas.
- Tamaño mínimo: 9 pt en A4/Carta; 8 pt solo para notas.
...
- Usar máximo 2 familias tipográficas.
